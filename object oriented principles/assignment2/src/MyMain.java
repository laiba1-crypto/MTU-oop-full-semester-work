...
public class MyMain {
	...
	// --------------------------------------------------
	/**
	 * This function tests the functionality of the class
	 * CompanySoftwareProject.<br>
	 */
	 ...
	 * The function shows the main class and object-related concepts we must know
	 * for the module.<br>
	 * 2) It calls to refVarsFunctionality.<br>
	 * The function shows the main primitive vs. reference variables concepts we
	 * must know for the module.<br>
	 * 
	 * @param args: We will run the program parameter free, so do not worry about
	 *              it.
	 */
